...
export const SPECIES = [
    ...
    },
    {
        ...
        size: 'Small',
        note: 'Tiers of horizontal branches, and the only one here that blossoms without going on to fruit.',
        matureHeight: 4.0,
        evergreen: false,
        blossom: 0xf6e8ec,
    ...
    },
    {
        ...
        name: 'Orange',
        size: 'Small',
        note: 'Glossy all year, the last of the orchard to ripen, and it holds its fruit deep into the winter.',
        matureHeight: 5.0,
        evergreen: true,
        bark: 0x8a7d6c,
        barkName: 'Smooth pale grey',
    ...
    },
    {
        ...
        name: 'Pear',
        size: 'Medium',
        note: 'Upright and formal, and the best autumn colour in the orchard.',
        matureHeight: 7.5,
        evergreen: false,
        bark: 0x5c5147,
