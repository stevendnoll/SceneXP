...
/**
 * xo-jersey.test.mjs - the X and the O on the shirt, measured.
 *
 ...
 * floating helmet ship twice (see xo-helmet). So this builds a figure
...
beforeAll(async () => {
    ...
    ({ XO_CONFIG: CFG } = await import(join(root, 'www/xo/js/config.js')));
