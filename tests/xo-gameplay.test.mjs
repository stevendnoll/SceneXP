...
const {
    XO_CONFIG: CFG, FIELD, SIM, UNITS_TO_METRES, formationSettings,
    simToWorld,
...
describe('the arms', () => {
     ...
     * running the solver forwards. `tests/xo-arm.test.mjs` checks the
     ...
     * wrong one for two rounds (see roster.js and tests/xo-helmet).
     */
